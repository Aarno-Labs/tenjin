...
impl Translation<'_> {
    ...
    fn call_form_cases(
        ...
        if let Some(call_form) = tenjin_use_crates::libz_rs_sys_call_form_cases(self, func) {
            return call_form;
        }

        if let Some(call_form) = tenjin_use_crates::libbz2_rs_sys_call_form_cases(self, func) {
            return call_form;
        }
