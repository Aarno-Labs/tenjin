...
#[no_mangle]
pub extern "C" fn isatty_stdout() -> ::core::ffi::c_int {
    atty::is(atty::Stream::Stdout) as ::core::ffi::c_int
}
#[no_mangle]
pub extern "C" fn isatty_stderr() -> ::core::ffi::c_int {
    atty::is(atty::Stream::Stderr) as ::core::ffi::c_int
}
#[no_mangle]
pub extern "C" fn isatty_stdin() -> ::core::ffi::c_int {
    atty::is(atty::Stream::Stdin) as ::core::ffi::c_int
}
#[no_mangle]
