...
def do_fmt_rs():
    ...
    hermetic.run_cargo_in(["fmt"], cwd=root / "xj-improve-relink", check=True)
...
def do_check_rs_fmt():
    ...
    hermetic.run_cargo_in(["fmt", "--", "--check"], cwd=root / "xj-improve-relink", check=True)
